...
ncaa_data_selected %>%
  mutate(multiyr_pub_award= cumsum(pub_award_06, pub_award_07, pub_award_08, pub_award_09, pub_award_10, pub_award_11, pub_award_12, pub_award_13, pub_award_14, pub_award_15, pub_award_16, pub_award_17, pub_award_18, pub_award_19))
